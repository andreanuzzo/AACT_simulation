...
reference_date <- as.Date('2020-02-21')
...
state_values <- c(
  S = Susceptible,
  E = (Susceptible-Infected-Recovered-Deaths),
  Is = Infected_symptomatic, 
  R = Recovered, 
  D = Deaths
)
...
SEIR.model <- function(current_timepoint, state_values, parameters){
  ...
  with(
    ...
    {
      ## compute derivatives
      dS = (-beta_value/N) * S * Is -alpha_value * E
      dE = (-beta_value/N) * S * Is - delta_value * E
